      ...
      <section className="py-20 bg-muted">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {highlights.map((item, index) => <Card key={index} className="text-center shadow-card hover:shadow-natural transition-shadow duration-300">
      ...
      <section className="py-20 bg-gradient-light">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {featuredProducts.map((product, index) => <Card key={index} className="overflow-hidden shadow-card hover:shadow-natural transition-all duration-300 hover:-translate-y-1">
