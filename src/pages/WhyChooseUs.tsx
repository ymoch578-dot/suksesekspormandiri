...
const WhyChooseUs = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <PageHero
        eyebrow={t('nav.whyChooseUs')}
        title={t('whyChooseUs.heroTitle')}
        subtitle={t('whyChooseUs.heroSubtitle')}
      />
